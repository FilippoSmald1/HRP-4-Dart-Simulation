  ...
  mWorld(_world)
{
	...
	solver = new mpcSolver::MPCSolver(0.05, mWorld->getTimeStep(), 1.0, comInitialPosition, CTH, singleSupportDuration, doubleSupportDuration, 0.30,
			0.08, 0.25, 0.15, 0.25, 0.1, 0.0); //0.05, 0.2, 0.1, 0.15, 0.1, 0.0   0.05, 0.3, 0.13, 0.17, 0.1, 0.0
	/**/
        //ArmSwing();
...
/*
       if (mWorld->getSimFrames()>=400 && mWorld->getSimFrames()<=407){ mTorso->addExtForce(Eigen::Vector3d(180,0,0)); //320
